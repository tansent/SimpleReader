...
import static jtli.com.simplereader.R.id.iv_three_one_three;
/**
...
public class ZhiHuAdapter extends BaseMultiItemQuickAdapter<HomeListBean, BaseViewHolder> {
    ...
    protected void convert(final BaseViewHolder helper, final HomeListBean item) {
        switch (helper.getItemViewType()) {
            case HomeListBean.TITLE:
                ...
                OnItemTitleClick(helper, R.id.ll, item.getTitle());
                break;
        ...
        public interface OnItemClickListener {
            ...
            void OnItemTitleClickListener(String id, View view);
        }
    ...
    public void OnItemTitleClick(BaseViewHolder helper, int id, final String title) {
        helper.getView(id).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                onItemClickListener.OnItemTitleClickListener(title, v);
            }
        });
    }
